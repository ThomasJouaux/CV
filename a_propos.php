...
<body>
    ...
    <div class="container-fluid">
            ...
            <div class="col-12 col-md-3 card_Left" id="card_Left">
                <div class="card">
                    <div class="card-body">
                        ...
                        <img src="src/img/photo_profil.jpeg" class="card-img-top" alt="photo_de_profil">
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item card_item"><strong>Nom : </strong> Jouaux</li>
                        <li class="list-group-item card_item"><strong>Prénom : </strong>Thomas</li>
                        <li class="list-group-item card_item"><strong> Age : </strong>
                            <?php
        ...
        <a class="btn btn_Pdf" href="src/docs/Thomas_JOUAUX_CV.pdf" target="_blank">Mon CV en pdf :</a>
